...
<main id="main" class="main googleads">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-xl-6 img-column column">
                    <img src="assets/img/hero-img.png" alt="google-ads">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="budget" class="container-fluid budget">
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-7 order-1 order-xl-1 column">
                ...
                <div class="col-12 col-xl-5 order-2 order-xl-2 column">
                    <div class="img">
    ...
    <section id="find" class="container-fluid find">
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-5 order-2 order-xl-1 column">
                    <div class="img">
                        <img src="assets/img/content1.png" alt="budget">
                    </div>
                </div>

                <div class="col-12 col-xl-7 order-1 order-xl-2 column">
